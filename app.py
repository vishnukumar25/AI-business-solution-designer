...
st.sidebar.markdown("[LinkedIn](https://www.linkedin.com/https://www.linkedin.com/in/vishnuv25/)")
...
if prompt:
    ...
    if any(prompt == s for s in FOLLOW_UP_SUGGESTIONS):
        ...
        This is a follow-up question: {prompt}

        Previous consultant response to refer to:
        {last_assistant_response}

        Please answer this follow-up question in the same structured format.
        """
    else:
        context_prompt = f"""
        Industry: {industry}
...
Always follow the exact response structure including COMPLEXITY tag at the top.
"""
            })
